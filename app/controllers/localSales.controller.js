...
const LocalSales = require('../models/localSales.model');
const {
    DEFAULT_LIMIT,
    ADD_DATA_SUCCESS,
    ADD_DATA_FAILED,
...
exports.findAll = (req, res) => {
    ...
    LocalSales.getAll(dataSearch, limit, (err, data) => {
        if (err) {
...
exports.findById = (req, res) => {
    ...
    LocalSales.findById(id, (err, data) => {
        if (err) {
            res.send({
                result: false,
                errors: [err],
...
exports.create = async (req, res) => {
    ...
    try {
        ...
        LocalSales.create(product, (err, data) => {
            if (err) {
                res.send({
                    result: false,
                    errors: [err],
...
exports.update = (req, res) => {
    ...
    try {
        ...
        LocalSales.updateById(product, (err, data) => {
            if (err) {
...
exports.updatePublish = (req, res) => {
    ...
    try {
        ...
        LocalSales.updatePublishById(id, publish, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: err[err] });
                return;
            }
...
exports.updateSort = (req, res) => {
    ...
    try {
        ...
        LocalSales.updateSortById(id, sort, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: [err] });
                return;
