...
exports.findAll = (req, res) => {
    ...
    Bank.getAll(dataSearch, limit, offset, orderby, (err, data) => {
        if (err) {
...
exports.update = (req, res) => {
    ...
    try {
        ...
        Bank.updateById(product, (err, data) => {
            if (err) {
...
exports.updatePublish = (req, res) => {
    ...
    try {
        ...
        Bank.updatePublishById(id, publish, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: [err] });
                return;
...
exports.updateSort = (req, res) => {
    ...
    try {
        ...
        Bank.updateSortById(id, sort, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: [err] });
                return;
