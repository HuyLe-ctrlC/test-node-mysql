...
exports.findAll = (req, res) => {
    ...
    Farms.getAll(dataSearch, limit, offset, orderby, (err, data) => {
        if (err) {
...
exports.update = (req, res) => {
    ...
    try {
        ...
        Farms.updateById(product, (err, data) => {
            if (err) {
...
exports.updatePublish = (req, res) => {
    ...
    try {
        ...
        Farms.updatePublishById(id, publish, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: [err] });
                return;
...
exports.updateSort = (req, res) => {
    ...
    try {
        ...
        Farms.updateSortById(id, sort, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: [err] });
                return;
