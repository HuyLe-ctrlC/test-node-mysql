...
const ProductCates = require('../models/productCates.model');
...
exports.findAll = (req, res) => {
    ...
    ProductCates.getAll(dataSearch, limit, (err, data) => {
        if (err) {
...
exports.findById = (req, res) => {
    ...
    ProductCates.findById(id, (err, data) => {
        if (err) {
            res.send({
                result: false,
                errors: [err],
...
exports.create = async (req, res) => {
    ...
    try {
        //req from client
        const product = new ProductCates({
            code: req.body.code,
            name: req.body.name,
        ...
        ProductCates.create(product, (err, data) => {
            if (err) {
                res.send({
                    result: false,
                    errors: [err],
...
exports.update = (req, res) => {
    ...
    try {
        ...
        ProductCates.updateById(product, (err, data) => {
            if (err) {
...
exports.updatePublish = (req, res) => {
    ...
    try {
        ...
        ProductCates.updatePublishById(id, publish, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: [err] });
                return;
...
exports.updateSort = (req, res) => {
    ...
    try {
        ...
        ProductCates.updateSortById(id, sort, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: [err] });
                return;
...
exports.delete = (req, res) => {
    const id = req.params.id;
    ProductCates.remove(id, (err, data) => {
        if (err) {
            res.send({ result: false, errors: [err] });
            return;
        }
        res.send({ result: true, data: [{ mess: DELETE_DATA_SUCCESS }] });
    });
};
