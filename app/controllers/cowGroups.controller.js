...
const CowGroups = require('../models/cowGroups.model');
...
exports.findAll = (req, res) => {
    ...
    CowGroups.getAll(dataSearch, limit, offset, orderby, (err, data) => {
        if (err) {
...
exports.findById = (req, res) => {
    ...
    CowGroups.findById(id, (err, data) => {
        if (err) {
            res.send({
                result: false,
                errors: [err],
...
exports.create = async (req, res) => {
    ...
    try {
        ...
        CowGroups.create(product, (err, data) => {
            if (err) {
                res.send({
                    result: false,
                    errors: [err],
...
exports.update = (req, res) => {
    ...
    try {
        ...
        CowGroups.updateById(product, (err, data) => {
            if (err) {
        ...
        res.send({ result: false, errors: [{ mess: UPDATE_DATA_FAILED }] });
    }
};
...
exports.updatePublish = (req, res) => {
    ...
    try {
        ...
        CowGroups.updatePublishById(id, publish, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: [err] });
                return;
...
exports.updateSort = (req, res) => {
    ...
    try {
        ...
        CowGroups.updateSortById(id, sort, (err, data) => {
            if (err) {
                // console.log(err);
                res.send({ result: false, errors: [err] });
                return;
