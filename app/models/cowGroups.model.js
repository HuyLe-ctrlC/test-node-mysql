...
//select data all
CowGroups.getAll = (dataSearch, limit, offset, orderby, result) => {
...
//update data by id
CowGroups.updateById = (data, result) => {
...
CowGroups.updatePublishById = (id, publish, result) => {
...
//update sort by id
CowGroups.updateSortById = (id, sort, result) => {
